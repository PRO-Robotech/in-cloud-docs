"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[4668,8069],{57368(e,t,l){l.r(t),l.d(t,{assets:()=>h,contentTitle:()=>m,default:()=>T,frontMatter:()=>N,metadata:()=>n,toc:()=>E});const n=JSON.parse('{"id":"tech-docs/etcd/components/etcd/downloadBIN","title":"downloadBIN","description":"\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u0440\u0430\u0431\u043e\u0447\u0438\u0445 \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0438\u0439","source":"@site/docs/tech-docs/etcd/components/etcd/downloadBIN.mdx","sourceDirName":"tech-docs/etcd/components/etcd","slug":"/tech-docs/etcd/components/etcd/downloadBIN","permalink":"/tech-docs/etcd/components/etcd/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var c=l(74848),a=l(28453),s=l(84146),d=l(57390),i=l(9792),r=l(59804),o=l(58700),O=l(68741);const u={value:s.A`
      #!/bin/bash
      set -Eeuo pipefail
    ...
    `},N={},m=void 0,h={},E=[];function p(e){return(0,c.jsxs)(r.A,{groupId:"install-type",children:[(0,c.jsxs)(i.A,{value:"Bash",children:[(0,c.jsx)("h4",{children:"\u0421\u043e\u0437\u0434\u0430\u043d\u0438\u0435 \u0440\u0430\u0431\u043e\u0447\u0438\u0445 \u0434\u0438\u0440\u0435\u043a\u0442\u043e\u0440\u0438\u0439"}),(0,c.jsx)(d.A,{language:"bash",children:s.A`
      mkdir -p /etc/default/etcd
    `}),(0,c.jsx)("h4",{children:"\u041f\u0435\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0435 \u043e\u043a\u0440\u0443\u0436\u0435\u043d\u0438\u044f"}),(0,c.jsx)(d.A,{language:"bash",children:s.A`
      cat <<EOF > /etc/default/etcd/download.env
      COMPONENT_VERSION="${O.M.etcdctl.value}"
      REPOSITORY="${o.m.etcdctl.baseUrl}"
      EOF
    `}),(0,c.jsx)("h4",{children:"\u0418\u043d\u0441\u0442\u0440\u0443\u043a\u0446\u0438\u044f \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438"}),(0,c.jsx)(d.A,{language:"bash",children:s.A`
      cat <<"EOF" > /etc/default/etcd/download-script.sh
      ${u.value}
      EOF
    `}),(0,c.jsx)("h4",{children:"\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0430 \u043f\u0440\u0430\u0432"}),(0,c.jsx)(d.A,{language:"yaml",children:s.A`
      chmod +x /etc/default/etcd/download-script.sh
    `}),(0,c.jsx)("h4",{children:"\u0421\u0435\u0440\u0432\u0438\u0441 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438"}),(0,c.jsx)(d.A,{language:"bash",children:s.A`
      ...
      EOF
    `}),(0,c.jsx)("h4",{children:"\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430"}),(0,c.jsx)(d.A,{language:"bash",children:s.A`
      systemctl enable etcd-install.service
      systemctl start etcd-install.service
    `})]}),(0,c.jsxs)(i.A,{value:"Cloud-init",children:[(0,c.jsx)("h4",{children:"\u041f\u0435\u0440\u0435\u043c\u0435\u043d\u043d\u044b\u0435 \u043e\u043a\u0440\u0443\u0436\u0435\u043d\u0438\u044f"}),(0,c.jsx)(d.A,{language:"yaml",children:s.A`
      #write_files:
      - path: /etc/default/etcd/download.env
        ...
        content: |
          COMPONENT_VERSION="${O.M.etcdctl.value}"
          REPOSITORY="${o.m.etcdctl.baseUrl}"
    `}),(0,c.jsx)("h4",{children:"\u0418\u043d\u0441\u0442\u0440\u0443\u043a\u0446\u0438\u044f \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438"}),(0,c.jsx)(d.A,{language:"yaml",children:s.A`
      - path: /etc/default/etcd/download-script.sh
        owner: root:root
        permissions: '0755'
        content: |
          ${u.value}
    `}),(0,c.jsx)("h4",{children:"\u0421\u0435\u0440\u0432\u0438\u0441 \u0437\u0430\u0433\u0440\u0443\u0437\u043a\u0438"}),(0,c.jsx)(d.A,{language:"yaml",children:s.A`
