        ...
        - path: ${c.M.kubeadmBaseConfigPath.value}/kubeadm.yaml
          ...
          content: |
            ...
            scheduler:
              extraArgs:
                ${h.hZ.data.value}
      `})})]})]})}function L(e={}){const{wrapper:a}={...(0,o.R)(),...e.components};return a?(0,l.jsx)(a,{...e,children:(0,l.jsx)(f,{...e})}):f(e)}},76519:(e,a,t)=>{t.d(a,{Q:()=>n});var r=t(60513),l=t(25292),o=t(63770),u=t(86613),i=t(7478);const n={data:{value:r.A`
      apiVersion: kubeadm.k8s.io/v1beta3
      kind: ClusterConfiguration
