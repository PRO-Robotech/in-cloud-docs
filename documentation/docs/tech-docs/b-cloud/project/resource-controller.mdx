...
5. Действия процесса реконсиляции при создании и изменении:
   ...
   - В ответ на события создания или изменения объекта процесс реконсиляции должен создавать новые или обновлять существующие ресурсы следующих типов, приводя их к требуемому состоянию:
     - Namespace
     - Role
     - RoleBinding
     - ProjectQuota
