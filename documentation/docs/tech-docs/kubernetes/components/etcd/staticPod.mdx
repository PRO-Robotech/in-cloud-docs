...
<CodeBlock language="bash">
    {dedent`
        export PORTS.etcdMetricServer.portNumber=${PORTS.etcdMetricServer.portNumber}
        export PORTS.etcdPeer.portNumber=${PORTS.etcdPeer.portNumber}
        export PORTS.etcdServer.portNumber=${PORTS.etcdServer.portNumber}
    `}
</CodeBlock>

<CodeBlock language="bash">
    {dedent`
        export CUSTOM_VALUE.kuberneteBaseFolderPath.value="${CUSTOM_VALUE.kuberneteBaseFolderPath.value}"
        ...
        export CUSTOM_VALUE.baseDockerRegistry.value="${CUSTOM_VALUE.baseDockerRegistry.value}"
        export COMPONENTS_VERSION.etcd.value="${COMPONENTS_VERSION.etcd.value}"
...
<CodeBlock language="bash">
  {dedent`
    ...
    metadata:
      annotations:
        kubeadm.kubernetes.io/etcd.advertise-client-urls: https://$\{MACHINE_LOCAL_ADDRESS}:${CUSTOM_VALUE.kuberneteBaseFolderPath.value}
