...
<CodeBlock language="bash">
    {dedent`
        ls -la /usr/lib/systemd/system/kubelet.service.d/10-kubeadm.yaml
    `}
</CodeBlock>
...
<CodeBlock language="bash">
    {dedent`
        -rw-r--r-- 1 root root 903 Feb 19 22:10 /usr/lib/systemd/system/kubelet.service.d/10-kubeadm.yaml
    `}
</CodeBlock>
:::
