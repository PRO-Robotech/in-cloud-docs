    ...
    <TabItem value='Bash'>
        ...
        <CodeBlock language="bash">
            {dedent`
                ...
                --container-runtime-endpoint=unix://${CUSTOM_VALUE.criEndpoint.value} \
                --pod-infra-container-image=${CUSTOM_VALUE.baseDockerRegistry.value}/${CUSTOM_VALUE.pausedImage.value} \
                --config=${CUSTOM_VALUE.kuberneteKubeletFolderPath.value}/custom-config.yaml \
