...
<Tabs groupId="install-type">
    ...
    <TabItem value='Bash'>
      ...
      <CodeBlock language="bash">
          {dedent`
            ...
            export INTERNAL_API=api.${CUSTOM_VALUE.kubernetesClusterDomain.value}
          `}
      </CodeBlock>
      ...
      <CodeBlock>
        {dedent`
          cat <<EOF > ${CUSTOM_VALUE.kuberneteBaseFolderPath.value}/kubeadm.conf
          ---
    ...
    <TabItem value='Cloud-init'>
      ...
      <CodeBlock>
        {dedent`
          - path: ${CUSTOM_VALUE.kuberneteBaseFolderPath.value}/kubeadm.conf
            owner: root:root
            permissions: '0644'
            content: |
              ---
