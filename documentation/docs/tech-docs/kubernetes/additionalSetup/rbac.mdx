...
<Tabs groupId="install-type">
  ...
  <TabItem value='HardWay'>
    ...
    <CodeBlock language="bash">
        ...
        {dedent`
          kubectl --kubeconfig=${CUSTOM_VALUE.kuberneteBaseFolderPath.value}/super-admin.conf apply -f - <<EOF
          ---
  ...
  <TabItem value='Kubeadm'>
    ...
    <CodeBlock language="bash">
        {dedent`
            kubeadm init phase bootstrap-token --config=${CUSTOM_VALUE.kuberneteBaseFolderPath.value}/kubeadm.conf
        `}
    </CodeBlock>
