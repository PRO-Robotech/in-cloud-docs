...
<Tabs groupId="install-type">
  ...
  <TabItem value='HardWay'>
    ...
    <details className="custom-gray-block">
      ...
      > Данный блок необходим, чтобы разрешить нодам читать ConfigMap `kubeadm-config` в пространстве имен `kube-system`:
    ...
    <details className="custom-gray-block">
      ...
      > Данный блок необходим, чтобы разрешить нодам читать ConfigMap `kubelet-config` в пространстве имен `kube-system`:
