...
<CodeBlock language="bash">
  {dedent`
    kubectl config set-cluster kubernetes \\
      ...
      --kubeconfig=${CUSTOM_VALUE.kubernetesBaseFolderPath.value}/kubelet.conf
...
<details className="custom-blue-block">
  ...
  <CodeBlock language="bash">
    {dedent`
      ${CUSTOM_VALUE.kubernetesBaseFolderPath.value}/openssl/cert-report.sh ${CERTIFICATES.kubeletCurrentClient.crtPath}
    `}
  </CodeBlock>
