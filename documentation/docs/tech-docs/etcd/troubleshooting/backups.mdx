...
<Tabs groupId="etcd-alias">
  ...
  <TabItem value='kectl'>
    ...
    :::note
    Обратите внимание, что для использования функции `dlbackupfile` необходимо задать переменные `SEARCH_NAMESPACE`, `SEARCH_POD_NAME`, `NODE_USERNAME` и `BACKUP_FILE`
