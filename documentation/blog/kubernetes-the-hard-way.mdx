...
description: 'Пошаговое ручное развёртывание Kubernetes-кластера без kubeadm: сертификаты, static pod-ы, kubeconfig и полная настройка управляющего контура.'
date: 2025-03-23
