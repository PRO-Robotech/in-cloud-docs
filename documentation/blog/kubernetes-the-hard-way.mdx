...
<p>
  Некоторые системы устроены так, что компоненты <strong>взаимозависимы</strong>, а управление ими частично выполняется <strong>внутри самой системы</strong>. Это требует чёткого порядка действий:
</p>
