...
<ul>
  ...
  <li>
    <a href="#4-базовая-настройка-узлов">4. Базовая настройка узлов</a>
  </li>
  <li>
    <a href="#5-загрузка-модулей-ядра">5. Загрузка модулей ядра</a>
  </li>
  <li>
    <a href="#6-настройка-параметров-sysctl">6. Настройка параметров sysctl</a>
  </li>
  <li>
    <a href="#7-установка-компонентов">7. Установка компонентов</a>
  </li>
  <li>
    <a href="#8-настройка-компонентов">8. Настройка компонентов</a>
  </li>
  <li>
    <a href="#9-проверка-готовности-компонентов">9. Проверка готовности компонентов</a>
  </li>
  <li>
    <a href="#10-работа-с-сертификатами">10. Работа с сертификатами</a>
  </li>
  <li>
    <a href="#11-создание-корневых-сертификатов">11. Создание корневых сертификатов</a>
  </li>
  <li>
    <a href="#12-создание-сертификатов-приложений">12. Создание сертификатов приложений</a>
  </li>
  <li>
    <a href="#13-создание-конфигураций-kubeconfig">13. Создание конфигураций kubeconfig</a>
  </li>
  <li>
    <a href="#14-создание-ключа-подписи-serviceaccount">14. Создание ключа подписи ServiceAccount</a>
  </li>
  <li>
    <a href="#15-проверка-блока-сертификатов">15. Проверка блока сертификатов</a>
  </li>
  <li>
    <a href="#16-создание-static-pod-ов-управляющего-контура">16. Создание static pod-ов управляющего контура</a>
  </li>
  <li>
    <a href="#17-создание-static-pod-ов-etcd-кластера">17. Создание static pod-ов ETCD кластера</a>
  </li>
  <li>
    <a href="#18-запуск-службы-kubelet">18. Запуск службы Kubelet</a>
  </li>
  <li>
    <a href="#19-проверка-состояния-кластера">19. Проверка состояния кластера</a>
  </li>
  <li>
    <a href="#20-настройка-ролевой-модели">20. Настройка ролевой модели</a>
  </li>
  <li>
    <a href="#21-загрузка-конфигурации-в-кластер">21. Загрузка конфигурации в кластер</a>
  </li>
  <li>
    <a href="#22-загрузка-корневых-сертификатов-в-кластер">22. Загрузка корневых сертификатов в кластер</a>
  </li>
  <li>
    <a href="#23-маркировка-и-ограничение-узлов">23. Маркировка и ограничение узлов</a>
  </li>
</ul>
