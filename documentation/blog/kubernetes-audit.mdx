...
:::note
Примеры silence-правил для подавления шума от системных компонентов.
:::
...
:::note
Примеры политик для фильтрации событий по пользователям и группам.
:::
...
:::note
Примеры политик для минимизации утечек чувствительных данных.
:::
...
:::note
Примеры политик для детального аудита только важных API.
:::

:::warning
Важно отслеживать действия с ресурсами, влияющими на безопасность кластера.
:::
