...
export const Input1: FC = () => {
  ...
  return (
    <Flex vertical gap="small">
      ...
      <Input placeholder="ETCD cluster node 1 name" value={nodeName1} onChange={e => setNodeName1(e.target.value)} />
      <Input placeholder="ETCD cluster node 2 name" value={nodeName2} onChange={e => setNodeName2(e.target.value)} />
      <Input placeholder="ETCD cluster node 3 name" value={nodeName3} onChange={e => setNodeName3(e.target.value)} />
      <Input placeholder="ETCD cluster node 1 IP address" value={nodeAddress1} onChange={e => setNodeAddress1(e.target.value)} />
      <Input placeholder="ETCD cluster node 2 IP address" value={nodeAddress2} onChange={e => setNodeAddress2(e.target.value)} />
      <Input placeholder="ETCD cluster node 3 IP address" value={nodeAddress3} onChange={e => setNodeAddress3(e.target.value)} />
      <Input placeholder="K8s cluster node 1 IP address" value={k8sNodeAddress1} onChange={e => setK8sNodeAddress1(e.target.value)} />
      <Input placeholder="K8s cluster node 2 IP address" value={k8sNodeAddress2} onChange={e => setK8sNodeAddress2(e.target.value)} />
      <Input placeholder="K8s cluster node 3 IP address" value={k8sNodeAddress3} onChange={e => setK8sNodeAddress3(e.target.value)} />
      <Input placeholder="ETCD cluster client connection port" value={clientPort} onChange={e => setClientPort(e.target.value)} />
      <Input placeholder="ETCD cluster inter-node connection port" value={peerPort} onChange={e => setPeerPort(e.target.value)} />
      <Input placeholder="Username for SSH connection to K8s cluster nodes" value={nodeUser} onChange={e => setNodeUser(e.target.value)} />
    </Flex>
  );
};
