...
<h4>Environment variables (general)</h4>
...
<h4>Environment variables (S3)</h4>
...
<h4>Preparing S3 configuration</h4>
...
<h4>Generating static pod manifest</h4>
