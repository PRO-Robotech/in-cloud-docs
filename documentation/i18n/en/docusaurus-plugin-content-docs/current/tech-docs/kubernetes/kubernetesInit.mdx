...
<CodeBlock language="bash">
    {dedent`
      ...
      [bootstrap-token] Using token: ${CUSTOM_VALUE.bootstrapToken.value}
      ...
      and service account keys on each node and then running the following as root:
        ...
        kubeadm join api.my-first-cluster.example.com:6443 --token ${CUSTOM_VALUE.bootstrapToken.value} \\
