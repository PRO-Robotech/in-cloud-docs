...
<summary>Static Pod Kube-Scheduler</summary>
...
<CodeBlock language="bash">
  {dedent`
    ...
    spec:
      ...
      # UNCOMMENT THE FOLLOWING
      # ->
      # - mountPath: ${KUBE_SCHEDULER_ARGS.tlsCertFile.value}
      #   name: kube-scheduler-crt
      #   readOnly: true
      # - mountPath: ${KUBE_SCHEDULER_ARGS.tlsPrivateKeyFile.value}
      ...
      # ->
      # - hostPath:
      #     path: ${KUBE_SCHEDULER_ARGS.tlsCertFile.value}
      #     type: FileOrCreate
      #   name: kube-scheduler-crt
      # - hostPath:
      #     path: ${KUBE_SCHEDULER_ARGS.tlsPrivateKeyFile.value}
      #     type: FileOrCreate
      #   name: kube-scheduler-key
    status: {}
    EOF
