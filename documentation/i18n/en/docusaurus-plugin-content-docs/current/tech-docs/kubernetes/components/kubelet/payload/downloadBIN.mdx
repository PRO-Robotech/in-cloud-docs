...
import { KUBELET_DOWNLOAD_SCRIPT }     from '@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/download-script.sh'
...
<Tabs groupId="install-type">
    ...
    <TabItem value='Cloud-init'>
        ...
        <h4>Download instructions/Permissions setup</h4>
        <CodeBlock language="yaml">
          {dedent`
