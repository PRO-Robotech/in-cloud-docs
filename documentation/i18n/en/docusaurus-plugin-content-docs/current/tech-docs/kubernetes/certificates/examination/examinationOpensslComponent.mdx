...
<h4>Script creation instructions</h4>
<details className="custom-gray-block">
<summary>Script creation instructions</summary>
<CodeBlock language="bash">
  {dedent`
...
<h4>Running the script for all certificates/kubeconfigs</h4>
<CodeBlock language="bash">
    {dedent`
...
<h4>Running the script for a single certificate/kubeconfig</h4>
<CodeBlock language="bash">
    {dedent`
