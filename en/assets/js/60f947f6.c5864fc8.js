"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[6461,6769],{4588(e,t,n){n.r(t),n.d(t,{assets:()=>b,contentTitle:()=>h,default:()=>p,frontMatter:()=>N,metadata:()=>l,toc:()=>m});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/kubectl/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubectl/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/kubectl","slug":"/tech-docs/kubernetes/components/kubectl/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/kubectl/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var s=n(74848),a=n(28453),c=n(84146),r=n(57390),o=n(58700),i=n(68741);const u={value:c.A`
      #!/bin/bash
      set -Eeuo pipefail
    ...
    `};var d=n(9792),O=n(59804);const N={},h=void 0,b={},m=[];function k(e){return(0,s.jsxs)(O.A,{groupId:"install-type",children:[(0,s.jsxs)(d.A,{value:"Bash",children:[(0,s.jsx)("h4",{children:"Creating working directories"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
            mkdir -p /etc/default/kubectl
          `}),(0,s.jsx)("h4",{children:"Environment variables"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
            cat <<EOF > /etc/default/kubectl/download.env
            COMPONENT_VERSION="${i.M.kubernetes.value}"
            REPOSITORY="${o.m.kubectl.baseUrl}"
            EOF
          `}),(0,s.jsx)("h4",{children:"Download instructions"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
          cat <<"EOF" > /etc/default/kubectl/download-script.sh
          ${u.value}
          EOF
        `}),(0,s.jsx)("h4",{children:"Permission setup"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
          chmod +x /etc/default/kubectl/download-script.sh
        `}),(0,s.jsx)("h4",{children:"Download service"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
          ...
          EOF
        `}),(0,s.jsx)("h4",{children:"Download"}),(0,s.jsx)(r.A,{language:"bash",children:c.A`
          systemctl enable kubectl-install.service
          systemctl start kubectl-install.service
        `})]}),(0,s.jsxs)(d.A,{value:"Cloud-init",children:[(0,s.jsx)("h4",{children:"Environment variables"}),(0,s.jsx)(r.A,{language:"yaml",children:c.A`
          - path: /etc/default/kubectl/download.env
            ...
            content: |
              COMPONENT_VERSION="${i.M.kubernetes.value}"
              REPOSITORY="${o.m.kubectl.baseUrl}"
        `}),(0,s.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,s.jsx)(r.A,{language:"yaml",children:c.A`
          - path: /etc/default/kubectl/download-script.sh
            owner: root:root
            permissions: '0755'
            content: |
              ${u.value}
        `}),(0,s.jsx)("h4",{children:"Download service"}),(0,s.jsx)(r.A,{language:"yaml",children:c.A`
