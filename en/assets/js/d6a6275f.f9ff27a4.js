"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[3448],{62242(e,r,t){t.r(r),t.d(r,{assets:()=>i,contentTitle:()=>h,default:()=>P,frontMatter:()=>k,metadata:()=>a,toc:()=>b});const a=JSON.parse('{"id":"tech-docs/kubernetes/certificates/components/kubeControllerManager/kubeControllerManagerServer/openssl","title":"openssl","description":"Environment variables","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/certificates/components/kubeControllerManager/kubeControllerManagerServer/openssl.mdx","sourceDirName":"tech-docs/kubernetes/certificates/components/kubeControllerManager/kubeControllerManagerServer","slug":"/tech-docs/kubernetes/certificates/components/kubeControllerManager/kubeControllerManagerServer/openssl","permalink":"/en/tech-docs/kubernetes/certificates/components/kubeControllerManager/kubeControllerManagerServer/openssl","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var n=t(74848),s=t(28453),l=t(65742),c=t(44349),o=t(57390),u=t(84146);const k={},h=void 0,i={},b=[];function d(e){return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("h4",{children:"Environment variables"}),"\n",(0,n.jsx)(o.A,{language:"bash",children:u.A`
  ...
  `}),"\n",(0,n.jsx)("h4",{children:"Configuration"}),"\n",(0,n.jsx)(o.A,{language:"bash",children:u.A`
  cat <<EOF > ${l.$.kubernetesControllerManagerServer.crtConf}
  [ req ]
  default_bits        = ${l.$.kubernetesControllerManagerServer.keySize}
  prompt              = no
  default_md          = sha256
  ...
  [ dn ]
  CN = "${l.$.kubernetesControllerManagerServer.cname}"
  ...
  subjectAltName=@alt_names
  EOF
`}),"\n",(0,n.jsx)("h4",{children:"Private key generation"}),"\n",(0,n.jsx)(o.A,{language:"bash",children:u.A`
  openssl genrsa \\
    -out ${l.$.kubernetesControllerManagerServer.keyPath} ${l.$.kubernetesControllerManagerServer.keySize}
`}),"\n",(0,n.jsx)("h4",{children:"CSR generation"}),"\n",(0,n.jsx)(o.A,{language:"bash",children:u.A`
  openssl req \\
  -new \\
  -key ${l.$.kubernetesControllerManagerServer.keyPath} \\
  -out ${l.$.kubernetesControllerManagerServer.csrPath} \\
  -config ${l.$.kubernetesControllerManagerServer.crtConf}
`}),"\n",(0,n.jsx)("h4",{children:"CSR signing"}),"\n",(0,n.jsx)(o.A,{language:"bash",children:u.A`
  openssl x509 \\
    -req \\
    -days 365 \\
    -sha256 \\
