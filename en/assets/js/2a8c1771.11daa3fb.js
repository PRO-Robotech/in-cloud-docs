"use strict";(globalThis.webpackChunkdocumentation=globalThis.webpackChunkdocumentation||[]).push([[6019,8794],{56646(e,t,a){a.r(t),a.d(t,{assets:()=>u,contentTitle:()=>l,default:()=>b,frontMatter:()=>d,metadata:()=>n,toc:()=>p});const n=JSON.parse('{"id":"tech-docs/kubernetes/additional-setup/upload-ca/all-ca","title":"5.2.4.4. CA upload","description":"This section covers uploading root certificates to the Kubernetes cluster.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/additional-setup/upload-ca/allUploadCAComponent.mdx","sourceDirName":"tech-docs/kubernetes/additional-setup/upload-ca","slug":"/tech-docs/kubernetes/additional-setup/upload-ca/all-ca","permalink":"/en/tech-docs/kubernetes/additional-setup/upload-ca/all-ca","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"all-ca","title":"5.2.4.4. CA upload"},"sidebar":"techDocs","previous":{"title":"5.2.4.3. \u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430 CFG","permalink":"/en/tech-docs/kubernetes/additional-setup/upload-configs/all-configs"}}');var o=a(74848),s=a(28453),c=a(28629),r=a(9792),i=a(76331);const d={id:"all-ca",title:"5.2.4.4. CA upload"},l=void 0,u={},p=[...c.toc];function h(e){const t={blockquote:"blockquote",code:"code",p:"p",...(0,s.R)(),...e.components},{Details:a}=t;return a||function(e,t){throw new Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("Details",!0),(0,o.jsxs)(o.Fragment,{children:[(0,o.jsxs)(t.blockquote,{children:["\n",(0,o.jsxs)(t.p,{children:["This section covers uploading root certificates to the Kubernetes cluster.\nThe kubeadm-certs secret is created manually and contains the keys and certificates required when adding new control plane nodes (",(0,o.jsx)(t.code,{children:"kubeadm join"}),").\nThis approach allows sensitive data to be securely transferred between control plane nodes."]}),"\n"]}),"\n",(0,o.jsx)(i.A,{groupId:"phase",children:(0,o.jsx)(r.A,{value:"init",label:"Init",children:(0,o.jsxs)(a,{children:[(0,o.jsx)("summary",{children:(0,o.jsxs)("div",{style:{display:"flex",justifyContent:"space-between",flexWrap:"wrap"},children:[(0,o.jsx)("p",{style:{marginBottom:0},children:"Uploading root certificates to Kubernetes"}),(0,o.jsx)("p",{className:"obligatory-note-orange",children:"\u25cf Required"})]})}),(0,o.jsx)(c.default,{})]})})})]})}function b(e={}){const{wrapper:t}={...(0,s.R)(),...e.components};return t?(0,o.jsx)(t,{...e,children:(0,o.jsx)(h,{...e})}):h(e)}},28629(e,t,a){a.r(t),a.d(t,{assets:()=>h,contentTitle:()=>p,default:()=>f,frontMatter:()=>u,metadata:()=>n,toc:()=>b});const n=JSON.parse('{"id":"tech-docs/kubernetes/additional-setup/upload-ca/uploadCAComponent","title":"uploadCAComponent","description":"This section provides instructions for uploading root certificates to the Kubernetes control plane. The certificates are uploaded in encrypted form as a Secret resource, which allows them to be securely transferred and decrypted on another node for managing the control plane node lifecycle.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/additional-setup/upload-ca/uploadCAComponent.mdx","sourceDirName":"tech-docs/kubernetes/additional-setup/upload-ca","slug":"/tech-docs/kubernetes/additional-setup/upload-ca/uploadCAComponent","permalink":"/en/tech-docs/kubernetes/additional-setup/upload-ca/uploadCAComponent","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var o=a(74848),s=a(28453),c=a(9792),r=a(76331),i=a(57390),d=a(60513),l=a(44349);const u={},p=void 0,h={},b=[];function m(e){const t={admonition:"admonition",blockquote:"blockquote",code:"code",p:"p",...(0,s.R)(),...e.components};return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(t.admonition,{title:"Note",type:"warning",children:(0,o.jsxs)(t.p,{children:["This section provides instructions for uploading root certificates to the Kubernetes control plane. The certificates are uploaded in encrypted form as a ",(0,o.jsx)(t.code,{children:"Secret"})," resource, which allows them to be securely transferred and decrypted on another node for managing the control plane node lifecycle."]})}),"\n",(0,o.jsxs)(r.A,{groupId:"install-type",children:[(0,o.jsxs)(c.A,{value:"HardWay",children:[(0,o.jsx)("h4",{children:"Environment variables for configuration file template"}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
      export AUTH_EXTRA_GROUPS="system:bootstrappers:kubeadm:default-node-token"
    `}),(0,o.jsx)("h4",{children:"Role model preparation"}),(0,o.jsxs)(t.blockquote,{children:["\n",(0,o.jsx)(t.p,{children:"This block prepares the role model for granting access to the kubeadm-certs secret. This is necessary so that control plane nodes can securely obtain root certificates through the Kubernetes API when joining the cluster. The role is bound to the ${AUTH_EXTRA_GROUPS} group, which kubeadm typically falls under during join."}),"\n"]}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
      kubectl \\
      ...
      EOF
    `}),(0,o.jsx)("h4",{children:"Working directory"}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
      mkdir -p ${l.M.kubernetesBaseFolderPath.value}/openssl
    `}),(0,o.jsx)("h4",{children:"Environment variables"}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
    ...
    `}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
      ...
      EOF
    `}),(0,o.jsx)("h4",{children:"Setting permissions"}),(0,o.jsx)(i.A,{language:"yaml",children:d.A`
      chmod +x ${l.M.kubernetesBaseFolderPath.value}/openssl/upload-certs.sh
    `}),(0,o.jsx)("h4",{children:"Running the script"}),(0,o.jsx)(i.A,{language:"yaml",children:d.A`
      ${l.M.kubernetesBaseFolderPath.value}/openssl/upload-certs.sh
    `}),(0,o.jsx)(t.admonition,{title:"Command output",type:"note",children:(0,o.jsx)(i.A,{language:"yaml",children:d.A`
...
`})})]}),(0,o.jsxs)(c.A,{value:"Kubeadm",children:[(0,o.jsx)("h4",{children:"Uploading certificates"}),(0,o.jsx)(i.A,{language:"bash",children:d.A`
      kubeadm init phase  upload-certs \\
        --config=${l.M.kubeadmBaseConfigPath.value}/kubeadm.yaml \\
        --kubeconfig=${l.M.kubernetesBaseFolderPath.value}/super-admin.conf \\
        --upload-certs
    `}),(0,o.jsx)(t.admonition,{type:"note",children:(0,o.jsx)(i.A,{language:"bash",children:d.A`
  [upload-certs] Storing the certificates in Secret "kubeadm-certs" in the "kube-system" Namespace
  [upload-certs] Using certificate key:
  0c00c2fd5c67c37656c00d78a9d7e1f2eb794ef8e4fc3e2a4b532eb14323cd59
`})})]})]})]})}function f(e={}){const{wrapper:t}={...(0,s.R)(),...e.components};return t?(0,o.jsx)(t,{...e,children:(0,o.jsx)(m,{...e})}):m(e)}}}]);