"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[2102,2630],{28778(e,t,n){n.r(t),n.d(t,{assets:()=>c,contentTitle:()=>u,default:()=>h,frontMatter:()=>o,metadata:()=>a,toc:()=>d});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/payload/dir","title":"dir","description":"{dedent`","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/payload/dir.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet/payload","slug":"/tech-docs/kubernetes/components/kubelet/payload/dir","permalink":"/en/tech-docs/kubernetes/components/kubelet/payload/dir","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=n(74848),s=n(28453),i=n(84146),l=n(57390);const o={},u=void 0,c={},d=[];function b(e){return(0,r.jsx)(l.A,{language:"bash",children:i.A`
  ...
  `})}function h(e={}){const{wrapper:t}={...(0,s.R)(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(b,{...e})}):b()}},96493(e,t,n){n.r(t),n.d(t,{assets:()=>p,contentTitle:()=>m,default:()=>E,frontMatter:()=>h,metadata:()=>a,toc:()=>k});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/payload/setupSystemdUnit","title":"setupSystemdUnit","description":"The dropin configuration 10-kubeadm.conf separates parameters into three levels: bootstrap-kubeconfig is used during initial node registration in the cluster (before obtaining a permanent kubelet.conf), kubeadm-flags.env contains flags that kubeadm init / kubeadm join generate dynamically during initialization, and extra-args.env allows specifying additional arguments (e.g., --cloud-provider=external when using Cloud Controller Manager).","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/payload/setupSystemdUnit.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet/payload","slug":"/tech-docs/kubernetes/components/kubelet/payload/setupSystemdUnit","permalink":"/en/tech-docs/kubernetes/components/kubelet/payload/setupSystemdUnit","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=n(74848),s=n(28453),i=n(84146),l=n(57390),o=n(44349),u=n(9792),c=n(59804),d=n(28778),b=n(58700);const h={},m=void 0,p={},k=[...d.toc];function g(e){const t={admonition:"admonition",blockquote:"blockquote",code:"code",em:"em",p:"p",strong:"strong",...(0,s.R)(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsxs)(t.blockquote,{children:["\n",(0,r.jsxs)(t.p,{children:["The dropin configuration ",(0,r.jsx)(t.code,{children:"10-kubeadm.conf"})," separates parameters into three levels: ",(0,r.jsx)(t.code,{children:"bootstrap-kubeconfig"})," is used during initial node registration in the cluster (before obtaining a permanent ",(0,r.jsx)(t.code,{children:"kubelet.conf"}),"), ",(0,r.jsx)(t.code,{children:"kubeadm-flags.env"})," contains flags that ",(0,r.jsx)(t.code,{children:"kubeadm init"})," / ",(0,r.jsx)(t.code,{children:"kubeadm join"})," generate dynamically during initialization, and ",(0,r.jsx)(t.code,{children:"extra-args.env"})," allows specifying additional arguments (e.g., ",(0,r.jsx)(t.code,{children:"--cloud-provider=external"})," when using Cloud Controller Manager)."]}),"\n"]}),"\n",(0,r.jsxs)(c.A,{groupId:"install-type",children:[(0,r.jsxs)(u.A,{value:"Bash",children:[(0,r.jsx)(d.default,{}),(0,r.jsx)("h4",{children:"Systemd Unit"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
      ...
      EOF
    `}),(0,r.jsx)("h4",{children:"Systemd Unit Config"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
      ...
      EOF
    `}),(0,r.jsxs)(c.A,{groupId:"ccm",children:[(0,r.jsxs)(u.A,{value:"Default",children:[(0,r.jsx)("h4",{children:"Systemd Unit ENV"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
          cat <<EOF > /etc/default/kubelet/extra-args.env
          KUBELET_EXTRA_ARGS=""
          EOF
        `})]}),(0,r.jsxs)(u.A,{value:"Cloud Controller Manager",children:[(0,r.jsx)("h4",{children:"Systemd Unit ENV"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
          cat <<EOF > /etc/default/kubelet/extra-args.env
          KUBELET_EXTRA_ARGS="--cloud-provider=external"
          EOF
        `})]})]}),(0,r.jsx)("h3",{children:"Add Systemd Unit to autostart"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
      systemctl enable kubelet
    `})]}),(0,r.jsxs)(u.A,{value:"Cloud-init",children:[(0,r.jsx)("h4",{children:"Systemd Unit ENV"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
      # write_files:
      - path: /usr/lib/systemd/system/kubelet.service
        ...
        content: |
          ...
          [Install]
          WantedBy=multi-user.target
    `}),(0,r.jsx)("h4",{children:"Download instructions"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
      # write_files:
      - path: /usr/lib/systemd/system/kubelet.service.d/10-kubeadm.conf
        ...
        content: |
          ...
          ExecStart=
          ExecStart=/usr/local/bin/kubelet $KUBELET_KUBECONFIG_ARGS $KUBELET_CONFIG_ARGS $KUBELET_KUBEADM_ARGS $KUBELET_EXTRA_ARGS
    `}),(0,r.jsx)("h4",{children:"Systemd Unit Download"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
      # write_files:
