"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[1643,5458],{49695(e,t,r){r.r(t),r.d(t,{assets:()=>v,contentTitle:()=>p,default:()=>P,frontMatter:()=>k,metadata:()=>a,toc:()=>b});const a=JSON.parse('{"id":"tech-docs/etcd/components/etcd/staticPodJoinComponent","title":"staticPodJoinComponent","description":"Environment variables","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/etcd/components/etcd/staticPodJoinComponent.mdx","sourceDirName":"tech-docs/etcd/components/etcd","slug":"/tech-docs/etcd/components/etcd/staticPodJoinComponent","permalink":"/en/tech-docs/etcd/components/etcd/staticPodJoinComponent","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var n=r(74848),s=r(28453),l=r(44349),c=r(285),o=r(68741),u=r(95538),i=r(84146),d=r(57390),h=r(28415);const k={},p=void 0,v={},b=[...h.toc];function m(e){const t={admonition:"admonition",blockquote:"blockquote",code:"code",p:"p",strong:"strong",...(0,s.R)(),...e.components},{Details:r}=t;return r||function(e,t){throw new Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("Details",!0),(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)("h4",{children:"Environment variables"}),"\n",(0,n.jsx)(h.default,{}),"\n",(0,n.jsx)(d.A,{language:"bash",children:(0,i.A)(`\n  export CLUSTER_NAME=${l.M.clusterName.value}\n  export BASE_DOMAIN=${l.M.kubernetesBaseDomain.value}\n  export MACHINE_LOCAL_ADDRESS=${l.M.virtualMachineLocalAddress.value}\n  export FULL_HOST_NAME=${l.M.virtualMachineFullName.value}\n\n  # Get the list of existing etcd nodes\n  mapfile -t ETCD_PODS < <(kubectl get pods \\\n    --kubeconfig=/etc/kubernetes/admin.conf \\\n    -n kube-system -l component=etcd \\\n    -o jsonpath="{range .items[*]}{.metadata.name} {.status.podIP}{'\\n'}{end}")\n\n  ETCD_EXISTING_NODES=""\n  ETCD_ENDPOINTS=""\n\n  for entry in "\${ETCD_PODS[@]}"; do\n    read -r podname podip <<< "$entry"\n    nodename="\${podname#etcd-}"\n    ETCD_EXISTING_NODES+="\${nodename}=https://\${podip}:2380,"\n    ETCD_ENDPOINTS+="https://\${podip}:2379,"\n  done\n\n  ETCD_EXISTING_NODES="\${ETCD_EXISTING_NODES%,}"\n  ETCD_ENDPOINTS="\${ETCD_ENDPOINTS%,}"\n\n  # Add the current node if it's not in the list\n  ETCD_CURRENT_NODE="\${FULL_HOST_NAME}=https://\${MACHINE_LOCAL_ADDRESS}:2380"\n\n  if [[ "$ETCD_EXISTING_NODES" == *"\${FULL_HOST_NAME}="* ]]; then\n    export ETCD_INITIAL_CLUSTER="$ETCD_EXISTING_NODES"\n  else\n    if [[ -n "$ETCD_EXISTING_NODES" ]]; then\n      export ETCD_INITIAL_CLUSTER="\${ETCD_EXISTING_NODES},\${ETCD_CURRENT_NODE}"\n    else\n      export ETCD_INITIAL_CLUSTER="\${ETCD_CURRENT_NODE}"\n    fi\n  fi\n\n  export ETCD_ENDPOINTS\n`)}),"\n",(0,n.jsx)("h4",{children:"Working directory"}),"\n",(0,n.jsx)(d.A,{language:"bash",children:i.A`
      mkdir -p ${l.M.kubernetesBaseFolderPath.value}/manifests
  `}),"\n",(0,n.jsxs)(r,{className:"custom-blue-block",children:[(0,n.jsx)("summary",{children:"Static Pod ETCD"}),(0,n.jsx)("h4",{children:"Manifest generation"}),(0,n.jsx)(d.A,{language:"bash",children:i.A`
  ...
  status: {}
  EOF
`})]}),"\n",(0,n.jsxs)(r,{className:"custom-blue-block",children:[(0,n.jsx)("summary",{children:"Expanding the ETCD cluster"}),(0,n.jsx)("h4",{children:"Adding a node"}),(0,n.jsxs)(t.blockquote,{children:["\n",(0,n.jsxs)(t.p,{children:["Declare an alias for ",(0,n.jsx)(t.code,{children:"etcdctl"})," using the required certificates"]}),"\n"]}),(0,n.jsx)(d.A,{language:"bash",children:i.A`
...
`}),(0,n.jsx)(t.admonition,{title:"Warning",type:"danger",children:(0,n.jsxs)(t.p,{children:["After adding the second node to the ETCD quorum, the first master may become ",(0,n.jsx)(t.strong,{children:"unavailable"})," until the second ETCD node is started.\nMake sure to start ETCD on the new node using ",(0,n.jsx)(t.code,{children:"kubelet"})," (see the step below) before continuing."]})})]})]})}function P(e={}){const{wrapper:t}={...(0,s.R)(),...e.components};return t?(0,n.jsx)(t,{...e,children:(0,n.jsx)(m,{...e})}):m(e)}},28415(e,t,r){r.r(t),r.d(t,{assets:()=>h,contentTitle:()=>d,default:()=>v,frontMatter:()=>i,metadata:()=>a,toc:()=>k});const a=JSON.parse('{"id":"tech-docs/kubernetes/setup-environments/secondaryMasters","title":"secondaryMasters","description":"{dedent`","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/setup-environments/secondaryMasters.mdx","sourceDirName":"tech-docs/kubernetes/setup-environments","slug":"/tech-docs/kubernetes/setup-environments/secondaryMasters","permalink":"/en/tech-docs/kubernetes/setup-environments/secondaryMasters","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var n=r(74848),s=r(28453),l=r(9792),c=r(59804),o=r(84146),u=r(57390);const i={},d=void 0,h={},k=[];function p(e){return(0,n.jsxs)(c.A,{children:[(0,n.jsx)(l.A,{value:"master-2",children:(0,n.jsx)(u.A,{language:"bash",children:o.A`
        export HOST_NAME=master-2
      `})}),(0,n.jsx)(l.A,{value:"master-3",children:(0,n.jsx)(u.A,{language:"bash",children:o.A`
