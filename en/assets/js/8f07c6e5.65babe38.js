"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[9259],{86426(e,t,l){l.r(t),l.d(t,{assets:()=>h,contentTitle:()=>b,default:()=>E,frontMatter:()=>N,metadata:()=>n,toc:()=>m});const n=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet/payload","slug":"/tech-docs/kubernetes/components/kubelet/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/kubelet/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var a=l(74848),s=l(28453),r=l(84146),i=l(57390),o=l(58700),u=l(68741);const c={value:r.A`
    ...
    `};var d=l(9792),O=l(59804);const N={},b=void 0,h={},m=[];function k(e){return(0,a.jsxs)(O.A,{groupId:"install-type",children:[(0,a.jsxs)(d.A,{value:"Bash",children:[(0,a.jsx)("h4",{children:"Creating working directories"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
            mkdir -p /etc/default/kubelet
          `}),(0,a.jsx)("h4",{children:"Environment variables"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
            cat <<EOF > /etc/default/kubelet/download.env
            COMPONENT_VERSION="${u.M.kubernetes.value}"
            REPOSITORY="${o.m.kubelet.baseUrl}"
            EOF
          `}),(0,a.jsx)("h4",{children:"Download instructions"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
          cat <<"EOF" > /etc/default/kubelet/download-script.sh
          ${c.value}
          EOF
        `}),(0,a.jsx)("h4",{children:"Permissions setup"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
          chmod +x /etc/default/kubelet/download-script.sh
        `}),(0,a.jsx)("h4",{children:"Download service"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
          ...
          EOF
        `}),(0,a.jsx)("h4",{children:"Download"}),(0,a.jsx)(i.A,{language:"bash",children:r.A`
          systemctl enable kubelet-install.service
          systemctl start kubelet-install.service
        `})]}),(0,a.jsxs)(d.A,{value:"Cloud-init",children:[(0,a.jsx)("h4",{children:"Environment variables"}),(0,a.jsx)(i.A,{language:"yaml",children:r.A`
          - path: /etc/default/kubelet/download.env
            ...
            content: |
              COMPONENT_VERSION="${u.M.kubernetes.value}"
              REPOSITORY="${o.m.kubelet.baseUrl}"
        `}),(0,a.jsx)("h4",{children:"Download instructions/Permissions setup"}),(0,a.jsx)(i.A,{language:"yaml",children:r.A`
          - path: /etc/default/kubelet/download-script.sh
            owner: root:root
            permissions: '0755'
            content: |
              ${c.value}
        `}),(0,a.jsx)("h4",{children:"Download service"}),(0,a.jsx)(i.A,{language:"yaml",children:r.A`
