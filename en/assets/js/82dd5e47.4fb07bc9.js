"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[2632,2801],{88193(e,n,t){t.r(n),t.d(n,{assets:()=>c,contentTitle:()=>s,default:()=>O,frontMatter:()=>l,metadata:()=>a,toc:()=>d});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/containerd/lifecycleDownloadComponent","title":"lifecycleDownloadComponent","description":"Component installation steps","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/containerd/lifecycleDownloadComponent.mdx","sourceDirName":"tech-docs/kubernetes/components/containerd","slug":"/tech-docs/kubernetes/components/containerd/lifecycleDownloadComponent","permalink":"/en/tech-docs/kubernetes/components/containerd/lifecycleDownloadComponent","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=t(74848),o=t(28453),i=t(87672);const l={},s=void 0,c={},d=[...i.toc];function u(e){const n={li:"li",ul:"ul",...(0,o.R)(),...e.components};return(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)("h3",{children:"Component installation steps"}),"\n",(0,r.jsxs)(n.ul,{children:["\n",(0,r.jsx)(n.li,{children:"Creating working directories."}),"\n",(0,r.jsx)(n.li,{children:"Environment variables."}),"\n",(0,r.jsx)(n.li,{children:"Download instructions."}),"\n",(0,r.jsx)(n.li,{children:"Permission setup."}),"\n",(0,r.jsx)(n.li,{children:"Download service."}),"\n",(0,r.jsx)(n.li,{children:"Starting the download service."}),"\n"]}),"\n",(0,r.jsx)(i.default,{})]})}function O(e={}){const{wrapper:n}={...(0,o.R)(),...e.components};return n?(0,r.jsx)(n,{...e,children:(0,r.jsx)(u,{...e})}):u(e)}},87672(e,n,t){t.r(n),t.d(n,{assets:()=>h,contentTitle:()=>m,default:()=>g,frontMatter:()=>N,metadata:()=>a,toc:()=>p});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/containerd/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/containerd/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/containerd/payload","slug":"/tech-docs/kubernetes/components/containerd/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/containerd/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=t(74848),o=t(28453),i=t(84146),l=t(57390),s=t(58700),c=t(68741);const d={value:i.A`
    ...
    `};var u=t(9792),O=t(59804);const N={},m=void 0,h={},p=[];function E(e){return(0,r.jsxs)(O.A,{groupId:"install-type",children:[(0,r.jsxs)(u.A,{value:"Bash",children:[(0,r.jsx)("h4",{children:"Creating working directories"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
        mkdir -p /etc/default/containerd
      `}),(0,r.jsx)("h4",{children:"Environment variables"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
        cat <<EOF > /etc/default/containerd/download.env
        COMPONENT_VERSION="${c.M.containerd.value}"
        REPOSITORY="${s.m.containerd.baseUrl}"
        EOF
      `}),(0,r.jsx)("h4",{children:"Download instructions"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
        cat <<"EOF" > /etc/default/containerd/download-script.sh
        ${d.value}
        EOF
      `}),(0,r.jsx)("h4",{children:"Permission setup"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
        chmod +x /etc/default/containerd/download-script.sh
      `}),(0,r.jsx)("h4",{children:"Download service"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
        ...
        EOF
      `}),(0,r.jsx)("h4",{children:"Starting the download service"}),(0,r.jsx)(l.A,{language:"bash",children:i.A`
        systemctl enable containerd-install.service
        systemctl start containerd-install.service
      `})]}),(0,r.jsxs)(u.A,{value:"Cloud-init",children:[(0,r.jsx)("h4",{children:"Environment variables"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
      - path: /etc/default/containerd/download.env
        ...
        content: |
          COMPONENT_VERSION="${c.M.containerd.value}"
          REPOSITORY="${s.m.containerd.baseUrl}"
    `}),(0,r.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
      - path: /etc/default/containerd/download-script.sh
        owner: root:root
        permissions: '0755'
        content: |
          ${d.value}
    `}),(0,r.jsx)("h4",{children:"Download service"}),(0,r.jsx)(l.A,{language:"yaml",children:i.A`
