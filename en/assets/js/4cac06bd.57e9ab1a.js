"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[9076],{14256(e,t,l){l.r(t),l.d(t,{assets:()=>m,contentTitle:()=>h,default:()=>p,frontMatter:()=>N,metadata:()=>n,toc:()=>E});const n=JSON.parse('{"id":"tech-docs/kubernetes/components/crictl/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/crictl/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/crictl/payload","slug":"/tech-docs/kubernetes/components/crictl/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/crictl/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=l(74848),c=l(28453),a=l(84146),i=l(57390),s=l(58700),o=l(68741);const d={value:a.A`
    ...
    `};var u=l(9792),O=l(59804);const N={},h=void 0,m={},E=[];function g(e){return(0,r.jsxs)(O.A,{groupId:"install-type",children:[(0,r.jsxs)(u.A,{value:"Bash",children:[(0,r.jsx)("h4",{children:"Creating working directories"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            mkdir -p /etc/default/crictl
          `}),(0,r.jsx)("h4",{children:"Environment variables"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            cat <<EOF > /etc/default/crictl/download.env
            COMPONENT_VERSION="${o.M.crictl.value}"
            REPOSITORY="${s.m.crictl.baseUrl}"
            EOF
          `}),(0,r.jsx)("h4",{children:"Download instructions"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            cat <<"EOF" > /etc/default/crictl/download-script.sh
            ${d.value}
            EOF
          `}),(0,r.jsx)("h4",{children:"Permission setup"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            chmod +x /etc/default/crictl/download-script.sh
          `}),(0,r.jsx)("h4",{children:"Download service"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            ...
            EOF
          `}),(0,r.jsx)("h4",{children:"Download"}),(0,r.jsx)(i.A,{language:"bash",children:a.A`
            systemctl enable crictl-install.service
            systemctl start crictl-install.service
          `})]}),(0,r.jsxs)(u.A,{value:"Cloud-init",children:[(0,r.jsx)("h4",{children:"Environment variables"}),(0,r.jsx)(i.A,{language:"yaml",children:a.A`
            - path: /etc/default/crictl/download.env
              ...
              content: |
                COMPONENT_VERSION="${o.M.crictl.value}"
                REPOSITORY="${s.m.crictl.baseUrl}"
          `}),(0,r.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,r.jsx)(i.A,{language:"yaml",children:a.A`
            - path: /etc/default/crictl/download-script.sh
              owner: root:root
              permissions: '0755'
              content: |
                ${d.value}
          `}),(0,r.jsx)("h4",{children:"Download service"}),(0,r.jsx)(i.A,{language:"yaml",children:a.A`
