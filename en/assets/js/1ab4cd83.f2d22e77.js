"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[5057,9259,9281],{63729(e,t,n){n.r(t),n.d(t,{assets:()=>c,contentTitle:()=>i,default:()=>O,frontMatter:()=>r,metadata:()=>l,toc:()=>u});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/lifecycleDownload","title":"Kubelet","description":"","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/lifecycleDownload.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet","slug":"/tech-docs/kubernetes/components/kubelet/lifecycleDownload","permalink":"/en/tech-docs/kubernetes/components/kubelet/lifecycleDownload","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var s=n(74848),o=n(28453),a=n(19417);const r={},i="Kubelet",c={},u=[...a.toc];function d(e){const t={h1:"h1",header:"header",...(0,o.R)(),...e.components};return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(t.header,{children:(0,s.jsx)(t.h1,{id:"kubelet",children:"Kubelet"})}),"\n",(0,s.jsx)(a.default,{})]})}function O(e={}){const{wrapper:t}={...(0,o.R)(),...e.components};return t?(0,s.jsx)(t,{...e,children:(0,s.jsx)(d,{...e})}):d(e)}},19417(e,t,n){n.r(t),n.d(t,{assets:()=>c,contentTitle:()=>i,default:()=>O,frontMatter:()=>r,metadata:()=>l,toc:()=>u});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/lifecycleDownloadComponent","title":"lifecycleDownloadComponent","description":"Component installation steps","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/lifecycleDownloadComponent.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet","slug":"/tech-docs/kubernetes/components/kubelet/lifecycleDownloadComponent","permalink":"/en/tech-docs/kubernetes/components/kubelet/lifecycleDownloadComponent","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var s=n(74848),o=n(28453),a=n(86426);const r={},i=void 0,c={},u=[...a.toc];function d(e){const t={li:"li",ul:"ul",...(0,o.R)(),...e.components};return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)("h3",{children:"Component installation steps"}),"\n",(0,s.jsxs)(t.ul,{children:["\n",(0,s.jsx)(t.li,{children:"Creating working directories."}),"\n",(0,s.jsx)(t.li,{children:"Environment variables."}),"\n",(0,s.jsx)(t.li,{children:"Download instructions."}),"\n",(0,s.jsx)(t.li,{children:"Permissions setup."}),"\n",(0,s.jsx)(t.li,{children:"Download service."}),"\n",(0,s.jsx)(t.li,{children:"Starting the download service."}),"\n"]}),"\n",(0,s.jsx)(a.default,{})]})}function O(e={}){const{wrapper:t}={...(0,o.R)(),...e.components};return t?(0,s.jsx)(t,{...e,children:(0,s.jsx)(d,{...e})}):d(e)}},86426(e,t,n){n.r(t),n.d(t,{assets:()=>m,contentTitle:()=>b,default:()=>p,frontMatter:()=>h,metadata:()=>l,toc:()=>N});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/kubelet/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubelet/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/kubelet/payload","slug":"/tech-docs/kubernetes/components/kubelet/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/kubelet/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var s=n(74848),o=n(28453),a=n(84146),r=n(57390),i=n(58700),c=n(68741);const u={value:a.A`
      #!/bin/bash
      set -Eeuo pipefail
    ...
    `};var d=n(9792),O=n(59804);const h={},b=void 0,m={},N=[];function k(e){return(0,s.jsxs)(O.A,{groupId:"install-type",children:[(0,s.jsxs)(d.A,{value:"Bash",children:[(0,s.jsx)("h4",{children:"Creating working directories"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
            mkdir -p /etc/default/kubelet
          `}),(0,s.jsx)("h4",{children:"Environment variables"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
            cat <<EOF > /etc/default/kubelet/download.env
            COMPONENT_VERSION="${c.M.kubernetes.value}"
            REPOSITORY="${i.m.kubelet.baseUrl}"
            EOF
          `}),(0,s.jsx)("h4",{children:"Download instructions"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
          cat <<"EOF" > /etc/default/kubelet/download-script.sh
          ${u.value}
          EOF
        `}),(0,s.jsx)("h4",{children:"Permissions setup"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
          chmod +x /etc/default/kubelet/download-script.sh
        `}),(0,s.jsx)("h4",{children:"Download service"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
          ...
          EOF
        `}),(0,s.jsx)("h4",{children:"Download"}),(0,s.jsx)(r.A,{language:"bash",children:a.A`
          systemctl enable kubelet-install.service
          systemctl start kubelet-install.service
        `})]}),(0,s.jsxs)(d.A,{value:"Cloud-init",children:[(0,s.jsx)("h4",{children:"Environment variables"}),(0,s.jsx)(r.A,{language:"yaml",children:a.A`
          - path: /etc/default/kubelet/download.env
            ...
            content: |
              COMPONENT_VERSION="${c.M.kubernetes.value}"
              REPOSITORY="${i.m.kubelet.baseUrl}"
        `}),(0,s.jsx)("h4",{children:"Download instructions/Permissions setup"}),(0,s.jsx)(r.A,{language:"yaml",children:a.A`
          - path: /etc/default/kubelet/download-script.sh
            owner: root:root
            permissions: '0755'
            content: |
              ${u.value}
        `}),(0,s.jsx)("h4",{children:"Download service"}),(0,s.jsx)(r.A,{language:"yaml",children:a.A`
