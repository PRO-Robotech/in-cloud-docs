"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[2801],{87672(e,n,t){t.r(n),t.d(n,{assets:()=>m,contentTitle:()=>h,default:()=>p,frontMatter:()=>N,metadata:()=>a,toc:()=>E});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/containerd/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/containerd/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/containerd/payload","slug":"/tech-docs/kubernetes/components/containerd/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/containerd/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var l=t(74848),r=t(28453),i=t(84146),o=t(57390),s=t(58700),c=t(68741);const d={value:i.A`
    ...
    `};var O=t(9792),u=t(59804);const N={},h=void 0,m={},E=[];function g(e){return(0,l.jsxs)(u.A,{groupId:"install-type",children:[(0,l.jsxs)(O.A,{value:"Bash",children:[(0,l.jsx)("h4",{children:"Creating working directories"}),(0,l.jsx)(o.A,{language:"bash",children:i.A`
        mkdir -p /etc/default/containerd
      `}),(0,l.jsx)("h4",{children:"Environment variables"}),(0,l.jsx)(o.A,{language:"bash",children:i.A`
        cat <<EOF > /etc/default/containerd/download.env
        COMPONENT_VERSION="${c.M.containerd.value}"
        REPOSITORY="${s.m.containerd.baseUrl}"
        EOF
      `}),(0,l.jsx)("h4",{children:"Download instructions"}),(0,l.jsx)(o.A,{language:"bash",children:i.A`
        cat <<"EOF" > /etc/default/containerd/download-script.sh
        ${d.value}
        EOF
      `}),(0,l.jsx)("h4",{children:"Permission setup"}),(0,l.jsx)(o.A,{language:"yaml",children:i.A`
        chmod +x /etc/default/containerd/download-script.sh
      `}),(0,l.jsx)("h4",{children:"Download service"}),(0,l.jsx)(o.A,{language:"bash",children:i.A`
        ...
        EOF
      `}),(0,l.jsx)("h4",{children:"Starting the download service"}),(0,l.jsx)(o.A,{language:"bash",children:i.A`
        systemctl enable containerd-install.service
        systemctl start containerd-install.service
      `})]}),(0,l.jsxs)(O.A,{value:"Cloud-init",children:[(0,l.jsx)("h4",{children:"Environment variables"}),(0,l.jsx)(o.A,{language:"yaml",children:i.A`
      - path: /etc/default/containerd/download.env
        ...
        content: |
          COMPONENT_VERSION="${c.M.containerd.value}"
          REPOSITORY="${s.m.containerd.baseUrl}"
    `}),(0,l.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,l.jsx)(o.A,{language:"yaml",children:i.A`
      - path: /etc/default/containerd/download-script.sh
        owner: root:root
        permissions: '0755'
        content: |
          ${d.value}
    `}),(0,l.jsx)("h4",{children:"Download service"}),(0,l.jsx)(o.A,{language:"yaml",children:i.A`
