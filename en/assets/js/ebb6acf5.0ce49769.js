      ...
      `}),(0,l.jsxs)(a.blockquote,{children:["\n",(0,l.jsxs)(a.p,{children:["This block is required so that when executing ",(0,l.jsx)(a.code,{children:"kubeadm join"}),", the node receives the current ",(0,l.jsx)(a.code,{children:"kubelet-config"})," from the control cluster and correctly joins the control-plane."]}),"\n"]}),(0,l.jsx)(n.A,{children:s.A`
        ...
        data:
          kubelet: |
            ${d.h.data.value}
        EOF
      `})]})]}),(0,l.jsxs)(i.A,{value:"Kubeadm",children:[(0,l.jsx)("h4",{children:"Configuration update"}),(0,l.jsx)(n.A,{language:"bash",children:s.A`
