"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[9107],{96336(e,t,a){a.r(t),a.d(t,{assets:()=>b,contentTitle:()=>N,default:()=>k,frontMatter:()=>O,metadata:()=>n,toc:()=>h});const n=JSON.parse('{"id":"tech-docs/kubernetes/components/kubeadm/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubeadm/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/kubeadm/payload","slug":"/tech-docs/kubernetes/components/kubeadm/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/kubeadm/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var l=a(74848),s=a(28453),r=a(84146),i=a(57390),o=a(58700),d=a(68741);const u={value:r.A`
    ...
    `};var c=a(9792),m=a(59804);const O={},N=void 0,b={},h=[];function E(e){return(0,l.jsxs)(m.A,{groupId:"install-type",children:[(0,l.jsxs)(c.A,{value:"Bash",children:[(0,l.jsx)("h4",{children:"Creating working directories"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
            mkdir -p /etc/default/kubeadm
          `}),(0,l.jsx)("h4",{children:"Environment variables"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
            cat <<EOF > /etc/default/kubeadm/download.env
            COMPONENT_VERSION="${d.M.kubernetes.value}"
            REPOSITORY="${o.m.kubeadm.baseUrl}"
            EOF
          `}),(0,l.jsx)("h4",{children:"Download instructions"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
          cat <<"EOF" > /etc/default/kubeadm/download-script.sh
          ${u.value}
          EOF
        `}),(0,l.jsx)("h4",{children:"Permission setup"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
          chmod +x /etc/default/kubeadm/download-script.sh
        `}),(0,l.jsx)("h4",{children:"Download service"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
          ...
          EOF
        `}),(0,l.jsx)("h4",{children:"Download"}),(0,l.jsx)(i.A,{language:"bash",children:r.A`
          systemctl enable kubeadm-install.service
          systemctl start kubeadm-install.service
        `})]}),(0,l.jsxs)(c.A,{value:"Cloud-init",children:[(0,l.jsx)("h4",{children:"Environment variables"}),(0,l.jsx)(i.A,{language:"yaml",children:r.A`
          - path: /etc/default/kubeadm/download.env
            ...
            content: |
              COMPONENT_VERSION="${d.M.kubernetes.value}"
              REPOSITORY="${o.m.kubeadm.baseUrl}"
        `}),(0,l.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,l.jsx)(i.A,{language:"yaml",children:r.A`
          - path: /etc/default/kubeadm/download-script.sh
            owner: root:root
            permissions: '0755'
            content: |
              ${u.value}
        `}),(0,l.jsx)("h4",{children:"Download service"}),(0,l.jsx)(i.A,{language:"yaml",children:r.A`
