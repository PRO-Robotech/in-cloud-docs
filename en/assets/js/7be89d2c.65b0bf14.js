"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[5364,8662,8881],{17255(e,n,t){t.r(n),t.d(n,{assets:()=>N,contentTitle:()=>m,default:()=>E,frontMatter:()=>O,metadata:()=>r,toc:()=>p});const r=JSON.parse('{"id":"tech-docs/kubernetes/components/runc/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/runc/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/runc","slug":"/tech-docs/kubernetes/components/runc/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/runc/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var s=t(74848),l=t(28453),c=t(84146),o=t(57390),a=t(58700),i=t(68741);const u={value:c.A`
    ...
    `};var d=t(9792),h=t(59804);const O={},m=void 0,N={},p=[];function g(e){return(0,s.jsxs)(h.A,{groupId:"install-type",children:[(0,s.jsxs)(d.A,{value:"Bash",children:[(0,s.jsx)("h4",{children:"Creating working directories"}),(0,s.jsx)(o.A,{language:"bash",children:c.A`
    ...
    `}),(0,s.jsx)("h4",{children:"Download instructions"}),(0,s.jsx)(o.A,{language:"bash",children:c.A`
      ...
      ${u.value}
      EOF
    `}),(0,s.jsx)("h4",{children:"Permissions setup"}),(0,s.jsx)(o.A,{language:"bash",children:c.A`
    ...
    `})]}),(0,s.jsxs)(d.A,{value:"Cloud-init",children:[(0,s.jsx)("h4",{children:"Environment variables"}),(0,s.jsx)(o.A,{language:"yaml",children:c.A`
      - path: /etc/default/runc/download.env
        ...
        content: |
          COMPONENT_VERSION="${i.M.runc.value}"
          REPOSITORY="${a.m.runc.baseUrl}"
    `}),(0,s.jsx)("h4",{children:"Download instructions/Permissions setup"}),(0,s.jsx)(o.A,{language:"yaml",children:c.A`
