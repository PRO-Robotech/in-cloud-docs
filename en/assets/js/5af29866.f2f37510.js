        ...
        - path: ${u.M.kubeadmBaseConfigPath.value}/kubeadm.yaml
          ...
          content: |
            ...
            scheduler:
              extraArgs:
                ${p.hZ.data.value}
      `})})]})]})}function x(e={}){const{wrapper:t}={...(0,o.R)(),...e.components};return t?(0,r.jsx)(t,{...e,children:(0,r.jsx)(y,{...e})}):y(e)}},46531(e,t,n){n.r(t),n.d(t,{assets:()=>p,contentTitle:()=>h,default:()=>b,frontMatter:()=>d,metadata:()=>a,toc:()=>v});const a=JSON.parse('{"id":"tech-docs/kubernetes/components/kubeadm/configs/joinConfig","title":"joinConfig","description":"Kubeadm configuration for joining a master node to the cluster","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubeadm/configs/joinConfig.mdx","sourceDirName":"tech-docs/kubernetes/components/kubeadm/configs","slug":"/tech-docs/kubernetes/components/kubeadm/configs/joinConfig","permalink":"/en/tech-docs/kubernetes/components/kubeadm/configs/joinConfig","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var r=n(74848),o=n(28453),s=n(57390),i=n(56223),l=n(60513),c=n(44349),u=n(285);const d={},h=void 0,p={},v=[];function m(e){const{Details:t}={...(0,o.R)(),...e.components};return t||function(e,t){throw new Error("Expected "+(t?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("Details",!0),(0,r.jsxs)(t,{children:[(0,r.jsx)("summary",{children:"Kubeadm configuration for joining a master node to the cluster"}),(0,r.jsx)("h4",{children:"Environment variables for configuration file template"}),(0,r.jsx)(s.A,{language:"bash",children:l.A`
