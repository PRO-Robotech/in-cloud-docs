"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[4963],{35981(e,a,t){t.r(a),t.d(a,{assets:()=>g,contentTitle:()=>m,default:()=>y,frontMatter:()=>b,metadata:()=>r,toc:()=>$});const r=JSON.parse('{"id":"tech-docs/kubernetes/components/kubeadm/configs/initConfig","title":"initConfig","description":"Kubeadm configuration for cluster initialization","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/kubeadm/configs/initConfig.mdx","sourceDirName":"tech-docs/kubernetes/components/kubeadm/configs","slug":"/tech-docs/kubernetes/components/kubeadm/configs/initConfig","permalink":"/en/tech-docs/kubernetes/components/kubeadm/configs/initConfig","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var l=t(74848),o=t(28453),i=t(84146),u=t(57390),n=t(95538),s=t(56223),c=t(44349),v=t(68741),d=t(12480),h=t(51908),p=t(9792),k=t(59804);const b={},m=void 0,g={},$=[];function f(e){const a={admonition:"admonition",code:"code",p:"p",...(0,o.R)(),...e.components},{Details:t}=a;return t||function(e,a){throw new Error("Expected "+(a?"component":"object")+" `"+e+"` to be defined: you likely forgot to import, pass, or provide it.")}("Details",!0),(0,l.jsxs)(t,{children:[(0,l.jsx)("summary",{children:"Kubeadm configuration for cluster initialization"}),(0,l.jsxs)(k.A,{groupId:"install-type",children:[(0,l.jsxs)(p.A,{value:"Bash",children:[(0,l.jsx)("h4",{children:"Environment variables for configuration file template"}),(0,l.jsx)(u.A,{language:"bash",children:i.A`
      ...
      `}),(0,l.jsx)("h4",{children:"Kubeadm configuration file for cluster initialization"}),(0,l.jsx)(a.admonition,{type:"warning",children:(0,l.jsxs)(a.p,{children:["Note that in this configuration file the ",(0,l.jsx)(a.code,{children:"addons"})," installation phase is skipped."]})}),(0,l.jsx)(u.A,{children:i.A`
        ...
        ${d.I.data.value}
        EOF
      `})]}),(0,l.jsx)(p.A,{value:"Cloud-init",children:(0,l.jsx)(u.A,{children:i.A`
      ...
      scheduler:
        ...
        #   pathType: File
    `}};t.d(a,["I",0,n])},51908(e,a,t){var r=t(84146),l=t(95538),o=t(56223),i=t(21232),u=t(21502);const n={data:{value:r.A`
