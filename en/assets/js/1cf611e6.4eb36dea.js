"use strict";(globalThis.webpackChunkdocumentation||=[]).push([[2032,9076],{58041(e,t,n){n.r(t),n.d(t,{assets:()=>o,contentTitle:()=>a,default:()=>O,frontMatter:()=>s,metadata:()=>l,toc:()=>d});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/crictl/lifecycleDownloadComponent","title":"lifecycleDownloadComponent","description":"Component installation steps","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/crictl/lifecycleDownloadComponent.mdx","sourceDirName":"tech-docs/kubernetes/components/crictl","slug":"/tech-docs/kubernetes/components/crictl/lifecycleDownloadComponent","permalink":"/en/tech-docs/kubernetes/components/crictl/lifecycleDownloadComponent","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var c=n(74848),r=n(28453),i=n(14256);const s={},a=void 0,o={},d=[...i.toc];function u(e){const t={li:"li",ul:"ul",...(0,r.R)(),...e.components};return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)("h3",{children:"Component installation steps"}),"\n",(0,c.jsxs)(t.ul,{children:["\n",(0,c.jsx)(t.li,{children:"Creating working directories."}),"\n",(0,c.jsx)(t.li,{children:"Environment variables."}),"\n",(0,c.jsx)(t.li,{children:"Download instructions."}),"\n",(0,c.jsx)(t.li,{children:"Permission setup."}),"\n",(0,c.jsx)(t.li,{children:"Download service."}),"\n",(0,c.jsx)(t.li,{children:"Starting the download service."}),"\n"]}),"\n",(0,c.jsx)(i.default,{})]})}function O(e={}){const{wrapper:t}={...(0,r.R)(),...e.components};return t?(0,c.jsx)(t,{...e,children:(0,c.jsx)(u,{...e})}):u(e)}},14256(e,t,n){n.r(t),n.d(t,{assets:()=>m,contentTitle:()=>h,default:()=>g,frontMatter:()=>N,metadata:()=>l,toc:()=>p});const l=JSON.parse('{"id":"tech-docs/kubernetes/components/crictl/payload/downloadBIN","title":"downloadBIN","description":"Creating working directories","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/tech-docs/kubernetes/components/crictl/payload/downloadBIN.mdx","sourceDirName":"tech-docs/kubernetes/components/crictl/payload","slug":"/tech-docs/kubernetes/components/crictl/payload/downloadBIN","permalink":"/en/tech-docs/kubernetes/components/crictl/payload/downloadBIN","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{}}');var c=n(74848),r=n(28453),i=n(84146),s=n(57390),a=n(58700),o=n(68741);const d={value:i.A`
    ...
    `};var u=n(9792),O=n(59804);const N={},h=void 0,m={},p=[];function E(e){return(0,c.jsxs)(O.A,{groupId:"install-type",children:[(0,c.jsxs)(u.A,{value:"Bash",children:[(0,c.jsx)("h4",{children:"Creating working directories"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            mkdir -p /etc/default/crictl
          `}),(0,c.jsx)("h4",{children:"Environment variables"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            cat <<EOF > /etc/default/crictl/download.env
            COMPONENT_VERSION="${o.M.crictl.value}"
            REPOSITORY="${a.m.crictl.baseUrl}"
            EOF
          `}),(0,c.jsx)("h4",{children:"Download instructions"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            cat <<"EOF" > /etc/default/crictl/download-script.sh
            ${d.value}
            EOF
          `}),(0,c.jsx)("h4",{children:"Permission setup"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            chmod +x /etc/default/crictl/download-script.sh
          `}),(0,c.jsx)("h4",{children:"Download service"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            ...
            EOF
          `}),(0,c.jsx)("h4",{children:"Download"}),(0,c.jsx)(s.A,{language:"bash",children:i.A`
            systemctl enable crictl-install.service
            systemctl start crictl-install.service
          `})]}),(0,c.jsxs)(u.A,{value:"Cloud-init",children:[(0,c.jsx)("h4",{children:"Environment variables"}),(0,c.jsx)(s.A,{language:"yaml",children:i.A`
            - path: /etc/default/crictl/download.env
              ...
              content: |
                COMPONENT_VERSION="${o.M.crictl.value}"
                REPOSITORY="${a.m.crictl.baseUrl}"
          `}),(0,c.jsx)("h4",{children:"Download instructions/Permission setup"}),(0,c.jsx)(s.A,{language:"yaml",children:i.A`
            - path: /etc/default/crictl/download-script.sh
              owner: root:root
              permissions: '0755'
              content: |
                ${d.value}
          `}),(0,c.jsx)("h4",{children:"Download service"}),(0,c.jsx)(s.A,{language:"yaml",children:i.A`
